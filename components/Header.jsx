...
<div class="flex justify-center items-center  rounded-lg bg-white relative">
<input class="search-input rounded-r-lg text-2xl text-blue-500 outline-none focus:outline-none:focus" type="search" autocomplete="off" spellcheck="false" aria-live="polite" placeholder="Files, Names..."/>
      <div class="search-icon bg-blue-500 hover:bg-blue-400 text-white px-3 py-3 rounded-lg relative z-10 shadow-md">
