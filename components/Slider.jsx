...
export function Slider(){
    return <div className="lg:flex lg:flex-col lg:justify-center lg:m-auto  lg:w-8/12">
        ...
        <div className="mt-8">
            <img className="inline-block h-80 md:w-full" src="https://s3-alpha-sig.figma.com/img/e8eb/3bce/c766a697a30822ccba768b03c5125ead?Expires=1707696000&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=mgqSGtIXQ7yRG4uKOvZPz6V9IGTLF-tRcsjBgyFTw0E8SJdcCQrLT3LSfDKzWdtHzDVzZJdMzANRqwjkTUtekRFXZfl8MmCIk05rFrhKWcSqUC1Wj~h8YjxKErPNcqc~s0I6TuisFBaoFOzMVS-2d8b1-F3tJwwTFP6nS17vjmsrtFLxW4pupdWj5VAhdoY903Mz4RcyEzIbDWxU6-u-1rFPd9nvzWzso~NgIm5xQ00lfanW7uGYU~9YinB4wPH9HP9Pm0Jdkdl9He~yrl1d5ZcxCdwLZNoXlmaxSUvm6Z4tqUDw68y3fAOEnDSBV~J5VFncEocAaDmHVwHKLmW6NA__"/>
        </div>
